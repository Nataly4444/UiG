  ...
  <div class="taskspace">
    <div class="main-container">
      ...
      <div class="tasks-container">
          ...
          <div class="tasks-container-center">
            ...
            <div class="block-with-tasks">
              <div class="tasks-title-2" @click="show = !show">
                ...
                <div class="box-task" v-else>-</div>Setup
                <span>(12)</span>
              </div>
            ...
            <div class="block-with-tasks">
              <div class="tasks-title-2" @click="show2 = !show2">
                ...
                <div class="box-task" v-else>-</div>Features for future releases
                <span>(19)</span>
              </div>
              <transition name="fade">
            ...
            <div class="block-with-tasks">
              <div class="tasks-title-2" @click="show3 = !show3">
                ...
                <div class="box-task" v-else>-</div>Documentation
                <span>(24)</span>
              </div>
              <transition name="fade">
        ...
        <div class="matrix">
          <img src="../assets/img/Task-Pace.jpg" style="display: block;" alt />
        </div>
      </div>
    </div>
  </div>
